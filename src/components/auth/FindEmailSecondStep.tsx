...
interface Props {
  ...
  firstStepValues: FindEmailFirstStepRequest;
}
...
const FindEmailSecondStep: React.FC<Props> = ({ next, firstStepValues }) => {
  ...
  const reSendCode = useCallback(async () => {
    try {
      await AuthService.findEmailFirstStep(firstStepValues);
